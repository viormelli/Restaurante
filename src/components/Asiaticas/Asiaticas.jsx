...
export default function AsiaticasSection() {
    const pratos = [
      {
        nome: "Moqueca",
    ...
    return (
      <div className="d-flex flex-wrap gap-5 py-10 px-6" style={{backgroundColor: '#da7323', alignItems: 'center', justifyContent: 'center'}}>
      {pratos.map((prato, index) => (
        <div key={index} className="bg-orange-400 rounded-lg overflow-hidden shadow-lg w-80 transform transition duration-300 hover:scale-105" style={{margin:'30px'}}>
          <div className="card" style={{ width: "18rem", backgroundColor: '#faefd9', border: 'transparent', borderRadius:'20px' }}>
            ...
            <div className="d-flex mt-2 m-4 d-grid gap-1" style={{justifyContent: 'center', alignItems:'center' }}>
              <button className="text-white rounded-full px-4 py-2 text-sm" style={{backgroundColor: '#da7323', border:'none', borderRadius:'20px' }}>
                Veja mais
              </button>
              <button className="text-white rounded-full px-4 py-2 text-sm" style={{backgroundColor: '#da7323', border:'none', borderRadius:'20px' }}>
                {prato.preco}
